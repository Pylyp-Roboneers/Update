...
echo $CLIENT_PASSWORD_201 | sshpass scp -o StrictHostKeyChecking=no /home/pylypvolodin/WorkDir/SoftUpdate/deployFromServer.sh deck@192.168.144.201:/home/deck/Downloads/
