...
echo $CLIENT_PASSWORD_213 | sshpass scp -P 2222 SoftUpDt.7z pi@77.222.152.213:/home/pi/theWD
echo -e "====Copy deployFromServer.sh to Client"
echo $CLIENT_PASSWORD_201 | sshpass scp deployFromServer.sh deck@192.168.144.201:/home/deck/Downloads
