...
"-P 2222 pi@77.222.152.213" адреса сервера в формі scp команди, якщо заданий порт сервера то аргумент повине бути з великої -P
...
- Визначає наявність та встановлює необхідні програми: 
             net-tools - щоб прочитати поточну inet адресу стімдеку  
             sshpass
             wireguard
             resolvconf - для розв'язання конфлікту конфігурації wireguard
  Програма resolvconf потребує перезавантаження; тому, якщо вона щойно встановилась, то Linux буде перезавантажуватись.
